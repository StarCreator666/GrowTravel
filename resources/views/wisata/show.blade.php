        ...
        <div class="jadwal">
            ...
            <p style="font-size: 15px; font-weight:300;" id="inclusion-none">PILIH INCLUSION ANDA</p>
                ...
                <div class="div" id="bronze" style="display: none;">
                    ...
                    @if($inclusionb != null)
                    <p style="font-size: 15px; font-weight:300;"><i class="fas fa-check fa-xs" style="color: rgb(35, 190, 35); padding-right:3px;"></i> {{ $inclusionb }}</p>
                    @endif
                    @endforeach
                </div>
                ...
                <div class="div" id="silver" style="display: none;">
                    ...
                    @if($inclusions != null)
                    <p style="font-size: 15px; font-weight:300;"><i class="fas fa-check fa-xs" style="color: rgb(35, 190, 35); padding-right:3px;"></i> {{ $inclusions }}</p>
                    @endif
                    @endforeach
                </div>
                ...
                <div class="div" id="gold" style="display: none;">
                    ...
                    @if($inclusiong != null)
                    <p style="font-size: 15px; font-weight:300;"><i class="fas fa-check fa-xs" style="color: rgb(35, 190, 35); padding-right:3px;"></i> {{ $inclusiong }}</p>
                    @endif
                    @endforeach
                </div>
                ...
                <div class="div" id="luxury" style="display: none;">
                    ...
                    @if($inclusionl != null)
                    <p style="font-size: 15px; font-weight:300;"><i class="fas fa-check fa-xs" style="color: rgb(35, 190, 35); padding-right:3px;"></i> {{ $inclusionl }}</p>
                    @endif
                    @endforeach
                </div>
